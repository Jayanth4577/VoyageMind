...
class PlacesAgent(BaseAgent):
    ...
    description: ClassVar[str] = 'Specializes in finding activities, attractions, and dining options.'
    ...
    def system_prompt(self) -> str:
        return """You are a places/activities specialist. Find attractions, restaurants, beaches, temples, markets matching user interests. NEVER invent ratings or costs. Return activity suggestions with data from search results.
...
Provide your final answer using the following JSON schema:
{
  ...
  "reasoning": "str"
    ...
    def _build_user_prompt(self, context: AgentContext) -> str:
        ...
        return f"""Find the best places and activities based on the following details:
...
Extract the destination coordinates, interest tags from preferences, trip_style, and num_days to guide your search. Focus on providing real, verified places."""
