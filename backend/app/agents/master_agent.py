...
class IntentSchema(BaseModel):
    intent: str = Field(description="The classified intent: generate, optimize_route, optimize_budget, check_weather, recommend")
...
class MasterAgent:
    ...
    async def _parse_intent(self, context: AgentContext) -> str:
        ...
        try:
            ...
            if intent not in ['generate', 'optimize_route', 'optimize_budget', 'check_weather', 'recommend']:
                return "generate"
            return intent
