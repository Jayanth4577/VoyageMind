  ...
  return (
    <div className="space-y-4">
      <div className="rounded-xl border border-line bg-surface p-5">
        <h2 className="text-lg font-semibold text-ink">👥 Group travel preferences</h2>
            ...
            <div key={i} className="rounded-lg border border-line p-3">
              <div className="flex items-center gap-2">
                ...
                {people.length > 1 && (
                  <button
                    ...
                    className="text-line hover:text-danger"
              ...
              <div className="mt-2 flex flex-wrap gap-3">
                {allInterests.map((interest) => (
                  <label key={interest} className="text-xs text-inksoft">
                    {interest}
                    <input
                      type="range"
                      min={0}
        ...
        <div className="mt-3 flex gap-2">
          <button
            ...
            className="rounded-md border border-line px-3 py-2 text-sm text-inksoft hover:bg-surface2"
          >
            + Add traveler
          </button>
          <button
      ...
      {analysis && analysis.travelers > 0 && (
        <div className="rounded-xl border border-line bg-surface p-5">
          ...
          <ul className="mt-3 space-y-2">
            {Object.entries(analysis.balanced_weights).map(([interest, weight]) => (
              <li key={interest} className="text-sm">
                ...
                <div className="mt-0.5 h-2 overflow-hidden rounded bg-surface2">
                  <div
          ...
          {analysis.conflicts.length > 0 && (
            <div className="mt-3 rounded-lg bg-warnsoft p-3 text-sm text-warn">
